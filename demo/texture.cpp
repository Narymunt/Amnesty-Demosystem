...
*/
int texture::load( char* filename, int repeat, int filter, int compression,IDirect3DDevice8 *pd )
{
...
/* 
 ...
 3 - trilinear, linear_mipmap_linear
*/
int texture::load( Image &im, int repeat, int filter, int compression,IDirect3DDevice8 *pd)
{
	compression =0;
