...
public:
	...
	void Render( DWORD hVertexShader = D3DFVF_XYZ|D3DFVF_TEX1|D3DFVF_TEXCOORDSIZE2(0),IDirect3DDevice8 *pd=NULL);
	int Init(float size=1.0f, IDirect3DDevice8 *pd=NULL);
